#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Code based on Robotis' "read write example": https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_sdk/sample_code/python_read_write_protocol_2_0/#python-read-write-protocol-20 
